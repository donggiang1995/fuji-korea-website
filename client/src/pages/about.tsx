...
export default function About() {
  ...
  const content = {
    ko: {
      ...
      vision: {
        title: '비전',
        description: '전 세계 엘리베이터 산업의 혁신을 주도하는 글로벌 리더가 되겠습니다.'
      },
      mission: {
        title: '사명',
        description: '최첨단 기술과 품질을 통해 고객에게 안전하고 편리한 수직 교통 솔루션을 제공합니다.'
      },
      values: [
    ...
    en: {
      ...
      vision: {
        title: 'Vision',
        description: 'To become a global leader driving innovation in the elevator industry worldwide.'
      },
      mission: {
        title: 'Mission',
        description: 'To provide safe and convenient vertical transportation solutions to customers through cutting-edge technology and quality.'
      },
      values: [
